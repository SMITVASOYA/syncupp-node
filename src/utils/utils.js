                                  ...
                                  <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social"
                                    ...
                                    <tr>
                                      ...
                                      <td align="center" valign="top" style="
                                            ...
                                            padding-right: 5px;
                                          ">
                                        <a target="_blank" href="${instagram}" style="
                                              -webkit-text-size-adjust: none;
                                              -ms-text-size-adjust: none;
                                              mso-line-height-rule: exactly;
                                              text-decoration: underline;
                                      ...
                                      <td align="center" valign="top" style="padding: 0; margin: 0">
                                        <a target="_blank" href="${facebook}" style="
                                              -webkit-text-size-adjust: none;
                                              -ms-text-size-adjust: none;
                                              mso-line-height-rule: exactly;
                                              text-decoration: underline;
...
white-space: nowrap;">${data?.contact_number ?? `&nbsp;`}</td>
                                  ...
                                  <a target="_blank" href="${
                                    process.env.REACT_APP_URL
                                  }/client/details/${data.reference_id}"style="
                                        -webkit-text-size-adjust: none;
                                        -ms-text-size-adjust: none;
                                        mso-line-height-rule: exactly;
                                        text-decoration: none;
...
// //     const randomColorCode = colorPalette[randomColorName];
// //     uniqueColors.add(randomColorCode);
// //   }

// //   return Array.from(uniqueColors);
// // };

// // exports.generateUniqueColors = () => {
// //   const randomColors = [];
// //   const colorNames = Object.keys(colorPalette);
...
// //       colorNames[Math.floor(Math.random() * colorNames.length)];
// //     const randomColorCode = colorPalette[randomColorName];
// //     randomColors.push(randomColorCode);
// //   }

// //   return randomColors;
// // };

// exports.generateUniqueColors = (objects) => {
//   const randomColors = [];
//   const colorNames = Object.keys(colorPalette);

//   if (Array.isArray(objects)) {
//     objects.forEach((object) => {
//       const coloredTags = object.tags.map((tag) => {
//         const randomColorName =
//           colorNames[Math.floor(Math.random() * colorNames.length)];
//         const randomColorCode = colorPalette[randomColorName];
//         return {
//           name: tag,
//           color: randomColorCode, // Adding the "color" property here
//         };
//       });

//       const randomObject = { ...object, coloredTags };
//       randomColors.push(randomObject);
//     });
//   } else {
